...
/*
 Once you add a table or update a field of the db:

1- Update CreateTable of the Table in UP and DropTable in Down (below)
2- Add Migration: Add-Migration MigrationName -Context GraceDbContext (we do this for updating the current database)
3- Update Table: Update-Database  -Context GraceDbContext (we do this for both creating or updating current databse)
